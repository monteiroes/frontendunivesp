...
export default function Home() {
  ...
  useEffect(() => {
    const productList = JSON.parse(store.get("productList"));

    setProductItems(productList);
  }, []);

  const enviarMensagem = () => {
    const number = "+5512996858343";
    ...
    let message = objToString(productArray);
    ...
    window.open(urlApi + "?phone=" + number + "&text=" + message, "_blank");
    // console.log(urlApi + "?phone=" + number + "&text=" + message, "_blank");
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Finalizar pedido | Name</title>
      ...
      <main className={styles.main}>
        <section className={styles.products}>
          ...
          <a href="#" onClick={enviarMensagem} className={styles.btnWhatsApp}>
            Finalizar pedido
          </a>
        </section>
      </main>
